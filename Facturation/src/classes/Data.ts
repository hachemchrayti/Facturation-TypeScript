import {HashHtmlFormat} from '../interfaces/HasHtmlFormat.js'

export class Data implements HashHtmlFormat{
        ...
        return  `
            ...
            <div class="row pb-5 p-5">
                <div class="col-sm-6 text-left">
                    <p class="font-weight-bold">Entreprise de Hachem</p>
                    <p class="mb-1">5ç Boulevard Jean Jaurés</p>
                    <p>92110 - Clichy</p>
